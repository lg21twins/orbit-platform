    ...
    return (
        <div className="min-h-screen bg-black overflow-hidden font-sans relative">
            ...
            <div className="relative z-10 p-6 pt-24">
                {/* Header controls */}
                <div className="max-w-6xl mx-auto mb-12 flex flex-col items-center md:items-end md:flex-row justify-between gap-8 md:gap-6 text-center md:text-left">
                    <div className="w-full md:w-auto">
                        <h1 className="text-4xl md:text-5xl font-black text-transparent bg-clip-text bg-gradient-to-br from-white to-gray-600 mb-2">
                            {t.orbit.title} FEED
                        </h1>
                    ...
                    <div className="flex flex-col md:flex-row items-center gap-4 w-full md:w-auto">
                        <div className="flex items-center gap-3 w-full justify-between md:justify-end md:w-auto mb-4 md:mb-0 px-4 md:px-0">
                            {/* Language Toggle */}
                            <button
                                onClick={toggleLang}
                        ...
                        <div className="flex overflow-x-auto w-full md:w-auto bg-white/5 p-1 rounded-xl backdrop-blur-md border border-white/10 no-scrollbar">
                            <div className="flex flex-nowrap min-w-full md:min-w-0">
                                {['all', 'popup', 'cafe', 'goods'].map((f) => (
                                    <button
                                        key={f}
                                        onClick={() => handleFilterChange(f.toUpperCase())}
                                        className={`flex-1 md:flex-none whitespace-nowrap px-6 py-2 rounded-lg text-sm font-bold transition-all ${filter === f.toUpperCase()
